...
| Draft lifecycle, ZERO new tools: `draft_gmail_message` action=create/update/delete + forward; `send_gmail_message(draft_id=...)` sends a draft as-is; `list_drafts` | tool params | supersedes upstream PR [#943](https://github.com/taylorwilsdon/google_workspace_mcp/pull/943) |
